...
@Component
public final class HelpForPrivate extends AbsGetCommand implements PrivateMessageCommandExecutor {
    @Override
    ...
    public void execute(final MessageCommandExecutorResponder responder, final IncomingMessage incomingMessage)
        ...
        outgoingMessage.setText(getHelpFileReader().read(Constants.HELP_PRIVAT_CHAT));
