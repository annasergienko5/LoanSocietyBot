...
* SCHEDULED_NO_DEBTS - Сообщение, отправляемые в общие чаты и в чаты админов при отсутствии участников, которые должны погасить
задолженность сегодня. Пример: "SCHEDULED_NO_DEBTS=Сегодня не ожидаются погашения задолженностей в срочном порядке."
...
* SCHEDULED_NO_DEBTS - текст сообщения отправляемого в случае отсутствия задолженностей.(раз в месяц) 
Пример: "SCHEDULED_NO_DEBTS=На сегодня должников нет."
* SCHEDULED_NO_TODAY_PAYS - текст сообщения отправляемого в случае отсутствия ожидаемых платежей. (раз в день)
Пример: "SCHEDULED_NO_TODAY_PAYS=Сегодня платежей в срочном порядке не ожидается."